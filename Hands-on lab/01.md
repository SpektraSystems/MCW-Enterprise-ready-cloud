...
5. Select the resource type and name suffix. In this case, we'll choose **virtualMachines** as the resource type and **vm** as the name suffix. **Do not select Save**.
